...
//		Toast.makeText(context, strResId, Toast.LENGTH_SHORT).show();
        initToast(Utils.getContext().getResources().getText(strResId), Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showLong(int strResId) {
        initToast(Utils.getContext().getResources().getText(strResId), Toast.LENGTH_LONG).show();
    }
    ...
    public static Toast showToastWithImg(final String tvStr, final int imageResource) {
        if (toast2 == null) {
            toast2 = new Toast(Utils.getContext());
        }
        View view = LayoutInflater.from(Utils.getContext()).inflate(R.layout.toast_custom, null);
