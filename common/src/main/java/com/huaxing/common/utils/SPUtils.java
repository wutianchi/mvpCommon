...
public final class SPUtils<T> {
    ...
    private SPUtils(final String spName) {
        sp = FastSharedPreferences.get(spName);
    }
     ...
     * @param values 值
     */
    public void put(@NonNull final String key, @NonNull final Class<T> values) {
        sp.edit().putSerializable(key, values).apply();
    }
     ...
     */
    public Class<T> getBeanClass(@NonNull final String key) {
        return (Class<T>) sp.getSerializable(key, null);
    }
